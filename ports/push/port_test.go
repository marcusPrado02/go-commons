...
// Compile-time check that PushPort can be implemented.
var _ push.PushPort = (*nilPush)(nil)

type nilPush struct{}

func (n *nilPush) Send(_ context.Context, _ push.PushNotification) (push.PushReceipt, error) {
	return push.PushReceipt{}, nil
}
func (n *nilPush) Ping(_ context.Context) error { return nil }

func TestPushNotification_Fields(t *testing.T) {
	n := push.PushNotification{
		Token: "tok-abc",
		Title: "Hello",
		Body:  "World",
